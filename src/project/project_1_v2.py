...
if __name__ == '__main__':
    ...
    save_to_excel(x0, E, W, D, uniform=False, parameter_calculation=parameter_calculation,
                  file='../../InputFea_av2.xlsx')

    print(optimize_v1(x0, E, W, D, u=False, parameter_calculation=parameter_calculation))
    for i in range(5):
        print(optimize_v1(x0, E, W, D, u=False, parameter_calculation=parameter_calculation, remove_edge=i))

    # xi = 2.30056943e-02
    # xi = None

    scipy_optimization(uniform=False, parameter_calculation=parameter_calculation)
